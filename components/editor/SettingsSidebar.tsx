          ...
          <>
            ...
            <button
              ...
              onClick={async () => {
                ...
                // Small async delay to show loading state before synchronous work
                await new Promise((r) => setTimeout(r, 50));
                setCaptions(generateMockCaptions(segments.filter((s) => s.kind === "keep")));
                setCaptionLoading(false);
                setCaptionDone(true);
                setTimeout(() => setCaptionDone(false), 2000);
              }}
              className={clsx(
            ...
            >
              ...
              {captionDone ? "✓ Captions Generated" : captionLoading ? "Generating…" : "Generate Captions"}
            </button>
          </>
        )}
